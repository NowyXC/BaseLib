 ...
 * # 状态栏透明
 * # 状态栏设置颜色和透明度
 * # 设置状态栏darkMode（夜间模式）,字体颜色及icon变黑
 * # 增加View的paddingTop,增加的值为状态栏高度
 * # 增加View的paddingTop,增加的值为状态栏高度,并重新设置View的高度
 */


/**
 * 使用{@link StatusBarManager}
 */
...
public class StatusBarUtil {
    ...
    public static final int MIN_API = 16;//最小API
    ...
    public static void immersive(Activity activity, @ColorInt int color, @FloatRange(from = 0.0, to = 1.0) float alpha) {
        immersive(activity.getWindow(), color, alpha);
    }

    public static void immersive(Activity activity,  @FloatRange(from = 0.0, to = 1.0) float alpha) {
        immersive(activity.getWindow(), DEFAULT_COLOR, alpha);
    }
    ...
    public static void immersive(Window window,@ColorInt int color, @FloatRange(from = 0.0, to = 1.0) float alpha) {
     ...
     */
    public static void darkMode(Activity activity,@ColorInt int color, boolean dark,boolean fitSystemWindow) {
        StatusBarCompat.setStatusBarColor(activity,color,dark,fitSystemWindow);
    }


    public static void darkMode(Activity activity,@ColorInt int color, boolean dark) {
        darkMode(activity,color,dark,true);
    }

    public static void darkMode(Activity activity, boolean dark) {
        StatusBarCompat.setStatusBarColor(activity,DEFAULT_COLOR,dark);
    }

    public static void immersiveDarkMode(Activity activity) {
        immersiveDarkMode(activity, DEFAULT_COLOR, DEFAULT_ALPHA);
    }

    public static void immersiveDarkMode(Activity activity, int color, @FloatRange(from = 0.0, to = 1.0) float alpha) {
