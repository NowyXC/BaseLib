...
public class SpannableStringUtils {
     ...
     * @return
     */
    public static CharSequence addColor(@ColorInt int color, String text) {
     ...
     * @return
     */
    public static SpannableStringBuilder addStrikethrough(String text){
        SpannableStringBuilder builder = new Builder().append(text).setStrikethrough().create();
        return builder;
    }



    public static SpannableStringBuilder setFontSize(String text,int textSize,boolean isDp){
        SpannableStringBuilder builder = new Builder().append(text)
                .setFontSize(textSize,isDp).create();
        return builder;
    }
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new CustomImageSpan(BaseApp.getInstance(), bitmap, align), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new CustomImageSpan(BaseApp.getInstance(), uri, align), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new CustomImageSpan(BaseApp.getInstance(), resourceId, align), start, end, flag);
                    resourceId = 0;
