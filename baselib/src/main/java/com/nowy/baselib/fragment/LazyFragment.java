...
public class LazyFragment extends BaseV4Fragment {
    ...
    protected int mLayoutBgRes = android.R.color.white;
    ...
    protected final void onCreateView(Bundle savedInstanceState) {
        ...
        if (isLazyLoad) {
            if (getUserVisibleHint() && !isInit) {
                ...
                layout.setBackgroundResource(mLayoutBgRes);
    ...
    public void setContentView(View view) {
        if (isLazyLoad && getContentView() != null && getContentView().getParent() != null && layout != null) {
            layout.removeAllViews();
            layout.addView(view);
        } else {
